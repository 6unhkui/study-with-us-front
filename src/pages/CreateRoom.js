    ...
    return (
        <CardWrap title="스터디방 만들기" size="small">
            ...
            <Form
                ...
                name="create"
                initialValues={{
                    category: categories.length > 0 ? categories[0].categoryId : 1
                }}
            ...
            >
                ...
                <MaxCountWrap>
                    ...
                    <Form.Item
                        ...
                        style={{
                            width: "100%",
                            display: maxCountLimit ? "block" : "none"
                        }}
                    >
                        <InputNumber
                ...
                <Form.Item name="thumbnail" label="Thumbnail" extra="* 썸네일은 이미지 형식의 파일만 등록 가능합니다.">
                    <ThumbnailWrap>
                        <div
