...
import {
    ...
    REGISTER_SUCCESS,
    REGISTER_FAILURE,
    CHECK_DUPLICATED_ACCOUNT_REQUEST,
    CHECK_DUPLICATED_ACCOUNT_SUCCESS,
    CHECK_DUPLICATED_ACCOUNT_FAILURE,
    LOG_IN_REQUEST,
    LOG_IN_SUCCESS,
    LOG_IN_FAILURE,
...
function* checkingAccountDuplication(action) {
    try {
        const {
            data: { data }
        } = yield call(checkingAccountDuplicationAPI, action.data);
        yield put({
...
function* uploadProfileImage(action) {
    try {
        const {
            data: { data }
        } = yield call(uploadProfileImageAPI, action.file);
        yield put({
