...
import {
    LOAD_MESSAGE_HISTORY_REQUEST, LOAD_MESSAGE_HISTORY_SUCCESS, LOAD_MESSAGE_HISTORY_FAILURE,
    LOAD_CURRENT_CHAT_MEMBERS_REQUEST, LOAD_CURRENT_CHAT_MEMBERS_SUCCESS, LOAD_CURRENT_CHAT_MEMBERS_FAILURE
...
export default function* memberSaga() {
    yield all([
        fork(watchLoadMessageHistory),
        fork(watchChatMemberInfo)
    ]);
}
