...
const RoomInfo = ({roomId}) => {
    ...
    const { roomDetail : {
        coverImage, coverGroupId, name, description, joinCount, createDate, category, categoryId, maxCount, unlimited, isManager
        ...
        <Descriptions title="스터디방 정보" bordered
            ...
            <Descriptions.Item label="카테고리" span={3}>
                {changeCategoryModalVisible &&
                    <CategorySelectLayer setLayerOpen={setChangeCategoryModalVisible}
